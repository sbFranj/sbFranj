...
<table>
  <tr>
    <th width="300" >Programming Languages</th>
    <th width="300">Frontend Development</th>
    <th width="300">Backend Development</th>
...
<table >
  ...
  <tr>
    ...
    <td><!--Software -->
      ...
      <a href="https://www.sonarsource.com/products/sonarlint/" target="_blank">
        <img src="https://static-00.iconduck.com/assets.00/sonarlint-icon-2048x2043-0bk0b6cv.png" alt="sonarlint" width="50" height=50"></a>
      <a href="https://swagger.io/" target="_blank">
        <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Swagger-logo.png" alt="sonarlint" width="50" height=50"></a>
    </td><!--Software END-->
    <td><!-- Others -->
      ...
      <a href="https://jwt.io/" target="_blank">
        <img style="margin: 10px" src="https://github.com/sbFranj/RecursosGraficos/blob/main/jwt.png" alt="" width="50" height=50" /></a>      
    </td><!-- Others END-->
  </tr>
</table>
...
<table>
  <tr>
    <td>      
      ...
      For 3 months starting in March 2024, I worked in a team of 6 people using technologies such as
      Angular, Spring Boot, and MySQL. We created a fully functional internal application for the company from scratch.
      Additionally, I individually developed an API with several microservices to support a fictional application for managing
      boats and members in a yacht club.
    </td>
    <td width="150" height=150">
      <img src="https://fransanchez.vercel.app/assets/professional/atoseviden.png"  />
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <b>Web Applications Development</b><br>
      2022/24      IES Jacarandá <br>
Formed at:<br>
Python - Java - JavaScript - Oracle - MySql - MongoDB - Dbeaber - HTML - CSS - Information systems - JSON - XML - Git - Eclipse - Visual Studio Code - DOM - Ajax - ypeScript - Axios - Angular - Express.js - React - Node.js - JSP - Spring Boot - Thymeleaf - Spring Api REST - JWT - Spring Security - Spring Email - JPA - Docker - Swagger - Bootstrap - Flex - Grid - Figma
    </td>
    <td height=150 width=300>
      <img  src="https://fransanchez.vercel.app/assets/academico/daw.jpg">
    </td>
  </tr>
</table>
<table>
  <tr>
    <td  height=150 width=300>
      <img  src="https://fransanchez.vercel.app/assets/academico/sist.jpg">
    </td>
    <td>
      Telecommunications and IT Systems<br>
      IES Axati     2018/20<br>
      Formed at:<br>
      Fiber optic installation - CNC systems Home automation - Audio and video systems 3D design and printing - Security control facility Electrical installation - Radio -television installation
    </td>
  </tr>
</table>
<table>
  <tr>
    <td>
      <b>Microcomputer systems and networks</b><br>
      2012/14     IES Axati <br>
Formed at:<br>
Assembly and maintenance of equipment - Operating systems - Office automation applications - Local networks - Network operating systems - Informatic security - Network services - Web applications
    </td>
    <td height=150 width=300>
      <img  src="https://fransanchez.vercel.app/assets/academico/smr.jpg">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td >
      <img src="https://fransanchez.vercel.app/assets/project/flicksense.png">
    </td>
    <td>
      <a href="https://flicksense.vercel.app/">
      <b >FlickSense</b></a>
      <h5>Final Integrated Project</h5>
            <p>
                FlickSense is a social network for movie lovers, featuring a (fictional) <a 
                    href="https://flicksense.vercel.app/movies">catalog</a> of over 1000 movies.
                Users can rate movies, write reviews, follow users with similar tastes, receive recommendations based on
                who they follow, read other users' reviews, see the average ratings and number of votes for each movie,
                search for movies, and more. Just <a href="https://flicksense.vercel.app/auth/register">register</a> to get
                started. If you become part of the staff, you'll be
                able to manage the movie catalog and users.
            </p>
            <h5>Fully functional application with security and roles, fully deployed</h5>
            <p>Technologies used: <br>
                Angular, Spring Boot, and MySQL</p>
    </td>
  </tr>
</table>
<table>
  <td>
    <a href="https://my-app-front-one.vercel.app/"><b>My App</b></a>
    <h5>Free project</h5>
            <p>
                My app is a web application with tools for playing board games, currently only for Party & CO.
                It is a tool that replaces
               physical cards
                with digital ones, also with a <a href="https://my-app-front-one.vercel.app/party/partida">timer
                    and shuffle cards.</a> A button to review the game rules, another to save the game.
                <a href="https://my-app-front-one.vercel.app/party/cartas" >A
                    catalog</a> to view all the cards, and a search function. With the administrator role, the
                complete CRUD to manage the cards.
            </p>
            <h5>Fully functional application with security and roles, fully deployed</h5>
            <p>Technologies used: <br>
                Angular, Spring Boot, and MySQL</p>
  ...
  <td>
    <img src="https://fransanchez.vercel.app/assets/project/myapp.jpg">
  </td>
</table>
